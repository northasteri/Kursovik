...
func (bf *BloomFilter) Naiv(item []byte) bool {
...
func main() {
	...
	fmt.Println("element-1:", filter.Naiv([]byte("element-1")))

	fmt.Println("element-455000:", filter.Naiv([]byte("element-455000")))
}
